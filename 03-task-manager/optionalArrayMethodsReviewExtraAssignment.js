...
console.log();
console.log("Each person's last name:\n", lastNamesOnly, '\n');
...
const firstSpaceLastNames = filterNames(names);
console.log(
	'Names that match the format "<first> <last>":\n',
	firstSpaceLastNames,
	'\n'
);
...
console.log('Names converted to "Title Case":', titleCaseNames, '\n');
...
const finalBossNames = titleCase(
	filterNames(firstSpaceLastNames).filter(name => !name.endsWith('z'))
);
console.log(
	'Names that match the format, don\'t end with z, and also converted to "Title Case", \
in message form:'
);
finalBossNames.forEach(name => console.log(`Hello ${name}, please sign up!`));
console.log();
